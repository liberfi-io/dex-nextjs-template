 ...
 *
 * Wraps the SDK's `DepositFlowWidget` (`@liberfi.io/ui-perpetuals`), which
 * owns the form, quote orchestration, FSM, polling, and confirmation /
 * status sub-modals. The host injects the side-effect bits the widget
 * purposefully does NOT own:
 *
          ...
          <div className="px-5 pb-5 pt-2">
            ...
            {!blocked && (
              <p className="mt-3 text-[11px] text-zinc-500 leading-relaxed text-center px-2">
                {t("extend.hlDeposit.recipientHint")}
              </p>
            )}
          </div>
        </div>
