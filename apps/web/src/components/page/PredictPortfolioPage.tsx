          ...
          <div className="flex shrink-0 items-center justify-between">
            ...
            <div className="hidden items-center gap-2 sm:flex">
              <button
                ...
                className="inline-flex cursor-pointer items-center gap-1.5 rounded-lg border border-positive/25 bg-positive/10 px-3.5 py-2 text-sm font-semibold text-positive transition-colors hover:border-positive/40 hover:bg-positive/20"
              >
              ...
              <button
                ...
                className="inline-flex cursor-pointer items-center gap-1.5 rounded-lg border border-border-control/60 bg-surface-interactive/50 px-3.5 py-2 text-sm font-semibold text-text-secondary transition-colors hover:border-border-control hover:bg-surface-interactive"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
                  <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
                  ...
                  <div className="max-sm:px-2">
                    <div className="relative min-w-0 flex-1 sm:w-[220px] sm:flex-none">
                      ...
                      <input
                        ...
                        className="mb-1.5 w-full rounded-lg border border-border-subtle/60 bg-surface-raised/40 py-1.5 pl-9 pr-3 text-xs text-text-secondary outline-none placeholder:text-text-disabled focus:border-border-control sm:mb-0"
                      />
                    </div>
                  </div>
                )}
    ...
    if (isError) {
      return (
        <div className={SUMMARY_GRID}>
          <div className="rounded-xl border border-border-subtle/50 bg-surface-raised/40 px-4 py-10 text-center text-sm text-text-muted lg:col-span-3">
