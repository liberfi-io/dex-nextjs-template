  ...
  return (
    <div className="space-y-3 pb-4">
      ...
      >
        <button
          type="button"
          className="flex h-10 shrink-0 cursor-pointer items-center rounded-md px-1.5 text-xs text-text-muted transition-colors hover:bg-surface-raised/60 hover:text-text-secondary sm:h-12 sm:px-2 sm:text-sm"
          onClick={selectToday}
        >
        ...
        <button
          ...
          className="flex h-10 w-7 shrink-0 cursor-pointer items-center justify-center rounded-md text-text-muted transition-colors hover:bg-surface-raised/60 hover:text-text-secondary disabled:cursor-not-allowed disabled:text-text-disabled disabled:hover:bg-transparent disabled:hover:text-text-disabled sm:h-12 sm:w-8"
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  selected
                    ? "border-border-control bg-surface-raised text-text-primary"
                    : "border-transparent text-text-muted hover:bg-surface-raised/60 hover:text-text-secondary",
                )}
        ...
        <button
          ...
          className="flex h-10 w-7 shrink-0 cursor-pointer items-center justify-center rounded-md text-text-muted transition-colors hover:bg-surface-raised/60 hover:text-text-secondary sm:h-12 sm:w-8"
      ...
      >
        <HorizontalScrollContainer
          ...
          classNames={{
            content: "gap-1.5",
            leftArrow: "from-surface-base",
            rightArrow: "from-surface-base",
          }}
        >
          <Link
            href={sportsLiveHref(
            ...
            className={cn(
              ...
              !hasActiveTaxonomy
                ? "border-border-control bg-surface-raised text-text-primary"
                : "border-border-subtle bg-surface-base text-text-muted hover:text-text-secondary",
            )}
          >
