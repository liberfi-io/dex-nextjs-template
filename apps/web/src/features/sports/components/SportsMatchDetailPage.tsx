...
export function SportsMatchDetailSkeleton({
  ...
  return (
    <main className="min-h-[calc(100vh-var(--header-height))] bg-surface-base px-3 py-4 text-text-primary sm:px-6">
      <div className="mx-auto w-full max-w-[1760px] space-y-4">
        <div className="rounded-[12px] border border-border-subtle bg-surface-raised/40 p-4">
          <div className="h-4 w-40 animate-pulse rounded bg-surface-interactive" />
          <div className="mt-4 h-8 w-full max-w-lg animate-pulse rounded bg-surface-interactive" />
          <div className="mt-3 text-sm text-text-muted">{matchGroupSlug}</div>
        </div>
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_360px]">
          <div className="h-[560px] animate-pulse rounded-[12px] border border-border-subtle bg-surface-raised/40" />
          <div className="h-[560px] animate-pulse rounded-[12px] border border-border-subtle bg-surface-raised/40" />
        </div>
      </div>
    </main>
