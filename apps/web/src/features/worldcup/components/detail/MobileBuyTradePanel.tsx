...
export function MobileBuyTradePanel({
  ...
  return (
    <>
      <div className="flex flex-col bg-surface-interactive px-4 pb-[calc(20px+env(safe-area-inset-bottom))] pt-3 text-text-primary">
        <div className="mx-auto mb-3 h-1 w-14 rounded-full bg-surface-strong" />
        <div className="flex items-center justify-between px-1 pb-1">
          ...
          <div
            className={cn(
              "flex items-center gap-0.5 rounded-[10px] bg-surface-raised/70 p-0.5",
        ...
        <div className="mt-2 flex items-center gap-3 px-1 py-1">
          ...
          <div className="flex min-w-0 flex-col gap-1">
            <span className="line-clamp-1 text-sm leading-tight text-text-muted">
              {String(eventTitle)}
            </span>
        ...
        <div className="mt-2 flex flex-col items-center px-1 py-2">
          ...
          <div className="flex w-full items-center justify-center">
            <input
              ...
              className={cn(
                "min-w-0 max-w-[260px] bg-transparent text-center text-5xl font-semibold leading-none outline-none placeholder:text-text-muted",
                hasAmount ? "text-text-primary" : "text-text-muted",
              )}
            />
          </div>

          {orderType === "limit" && supportsLimitOrder && (
            <div className="mt-2 flex items-center gap-2 rounded-[10px] bg-surface-raised/60 px-3 py-2">
              ...
              <input
                ...
                className="w-14 bg-transparent text-right text-sm font-semibold text-text-primary outline-none"
              />
          ...
          <div className="mt-3 flex flex-wrap items-center justify-center gap-2">
            {QUICK_AMOUNTS.map((amount) => (
              <button
                ...
                className="rounded-full bg-content2 px-3 py-1 text-sm font-medium text-text-muted transition-colors hover:bg-content3 hover:text-text-primary"
              >
                +${amount}
              </button>
            ))}
        ...
        <button
          ...
          className="flex items-center justify-between rounded-[10px] px-1 py-1.5 text-sm font-medium text-text-muted transition-colors hover:text-text-primary"
        >
        ...
        {oddsOpen && (
          <div className="mt-1 flex flex-col gap-y-1 px-1 pb-2 text-[13px] leading-5">
            ...
            <Metric
              ...
              valueClassName={
                hasAmount && potentialProfit > 0 ? "text-positive" : undefined
              }
            />
          </div>
        )}
        ...
        <button
          ...
          className="mt-4 flex h-12 w-full shrink-0 items-center justify-center rounded-[10px] bg-brand-primary text-base font-semibold text-text-inverse transition-colors hover:bg-brand-primary disabled:cursor-not-allowed disabled:opacity-60"
        >
