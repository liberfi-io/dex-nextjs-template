...
export function TradePanel({
  ...
  return (
    <div className="[&_.worldcup-trade-panel-form>div]:px-2 lg:[&_.worldcup-trade-panel-form>div]:px-4">
      <div className="mb-3 flex items-center gap-1 rounded-[10px] border border-border-subtle bg-surface-raised/60 p-0.5">
        <BuySellTab
          tone="bullish"
          active={side === "buy"}
      ...
      <div className="mb-4 flex items-center gap-x-3 px-2 lg:px-4">
        ...
        <div className="flex min-w-0 flex-col gap-y-0.5">
          ...
          <span className="line-clamp-1 text-base font-semibold leading-tight">
            ...
            <span
              className={cn(side === "buy" ? "text-positive" : "text-negative")}
            >
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active
          ? tone === "bearish"
            ? "bg-surface-interactive text-negative"
            : "bg-surface-interactive text-positive"
