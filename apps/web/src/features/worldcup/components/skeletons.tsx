...
const CARD = "rounded-[12px] border border-border-subtle bg-surface-raised/40";
...
function MatchCardSkeleton() {
  return (
    <div className="overflow-hidden rounded-[14px] border border-border-subtle/60 bg-surface-raised/40">
...
function BracketNodeSkeleton() {
  return (
    <div className="rounded-[10px] border border-border-subtle bg-surface-raised/50 p-2.5">
      ...
      <div className="mt-2 flex items-center justify-between border-t border-border-subtle/60 pt-1.5">
        <div className="flex h-[15px] items-center">
