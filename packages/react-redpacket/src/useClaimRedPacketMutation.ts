...
import { ChainStreamClient, ClaimRedPacketResponse } from "@chainstream-io/sdk";
...
export function useClaimRedPacketMutation(
  options: Omit<UseMutationOptions<ClaimRedPacketResponse, Error, ClaimRedPacketParams>, "mutationFn"> = {},
) {
